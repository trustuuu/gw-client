...
function SidebarScim({ sidebarOpen, setSidebarOpen }) {
  ...
  const { scim, domain } = useAuth();
  useEffect(() => {
    if (!scim) {
      navigate("/onboarding-scims");
    }
  }, []);
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3 ">
              ...
              <SidebarLinkGroup
                activecondition={
                  pathname === "/" || pathname.includes("scims-brief")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              {/* apps */}
              <SidebarLinkGroup
                activecondition={pathname.includes("scims-view-")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                        ...
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/onboarding-scims-view-setting"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500 "
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/onboarding-scims-view-authentication"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/onboarding-scims-view-configuration"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-indigo-500"
