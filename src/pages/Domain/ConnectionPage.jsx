...
function ConnectionPage() {
  ...
  const currentPosts = connections
    ? connections
        //.filter((d) => d.id !== connection.id)
  ...
  const onClickNew = function () {
    navigate("/onboarding-connection-new", {
      state: {
        company,
        domain,
        mode: "new",
    ...
    <div className="col-span-full xl:col-span-6 shadow-lg rounded-sm">
      ...
      <div className="p-3">
        ...
        <Pagination
          ...
          totalPosts={connections ? connections.length : 0}
          paginate={paginate}
          currentPage={currentPage}
          pageDisplayCount={
            connections
              ? Math.ceil(connections.length / postsPerPage) < pageDisplayCount
                ? Math.ceil(connections.length / postsPerPage)
                : pageDisplayCount
              : 0
          }
          pageStart={pageStart}
