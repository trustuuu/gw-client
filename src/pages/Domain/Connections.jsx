...
function Connections({
  ...
  const handleChangeCheck = function (e) {
    ...
    if (isChecked) {
      parentCallback([
        ...checkedItems,
        ...connections.filter((i) => i.id === item),
      ]);
      setCheckedItems([
        ...checkedItems,
        ...connections.filter((i) => i.id === item),
                ...
                >
                  <div className="self-center mr-3">
                    <Checkbox
                      ...
                      id={connection.id}
                      checked={
                        checkedItems.filter((i) => i.id === connection.id)
                          .length > 0
                      }
                  ...
                  <div className="grow flex items-center text-sm py-2">
                    <div
                      className="grow flex"
                      onClick={onClickView.bind(this, connection)}
                    >
                      <div className="self-center uppercase w-1/6 min-w-48">
                    ...
                    <div
                      ...
                      onClick={onClickEdit.bind(this, connection)}
                    >
