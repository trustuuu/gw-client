              ...
              return (
                ...
                >
                  <div className="self-center mr-3">
                    {handleChangeCheck ? (
                      <Checkbox
                        ...
                        id={policy.id}
                        checked={
                          checkedItems.filter((i) => i.id === policy.id)
                            .length > 0
                        }
                  ...
                  <div className="grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2">
                    <div
                      className="grow flex"
                      onClick={onClickView.bind(this, policy)}
                    >
                    ...
                    {onClickDel ? (
                      <div
                        ...
                        onClick={onClickDel.bind(this, policy)}
                      >
...
export default ApplicationExchanges;
