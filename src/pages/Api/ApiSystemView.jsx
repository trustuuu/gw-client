...
import ApiSystemUsersGroupsPage from "./ApiSystemUsersGroupsPage";

function ApiSystemView() {
  ...
  const data = [
    {
      ...
      content: (
        <ApiSystemUsersGroupsPage key="apiAppUsersGroups" mode="overview" />
      ),
      closeButton: false,
    },
  ];
