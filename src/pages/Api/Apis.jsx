...
function Apis({ apis, parentCallback, onClickView, onClickEdit }) {
                ...
                >
                  <div className="self-center mr-3">
                    <Checkbox
                      ...
                      id={api.id}
                      checked={
                        checkedItems.filter((i) => i.id == api.id).length > 0
                      }
                  ...
                  <div className="grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2">
                    <div
                      className="grow flex"
                      onClick={onClickView.bind(this, api)}
                    >
                    ...
                    <div
                      ...
                      onClick={onClickEdit.bind(this, api)}
                    >
