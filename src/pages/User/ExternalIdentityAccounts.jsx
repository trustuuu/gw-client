...
function ExternalIdentityAccounts({
  accounts,
  parentCallback,
  onClickView,
  onClickEdit,
              ...
              return (
                ...
                >
                  <div className="self-center mr-3">
                    {handleChangeCheck ? (
                      <Checkbox
                        ...
                        id={account.id}
                        checked={
                          checkedItems.filter((i) => i.id === account.id)
                            .length > 0
                        }
                  ...
                  <div className="grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2">
                    <div
                      className="grow flex"
                      onClick={onClickView.bind(this, account)}
                    >
                    ...
                    {onClickDel ? (
                      <div
                        ...
                        onClick={onClickDel.bind(this, account)}
                      >
...
export default ExternalIdentityAccounts;
