...
import {prop, path, sortWith, descend, head, reduce, groupBy, keys, length, sortBy, map} from 'ramda';
...
const sortByCreatedAtDesc = data => sortWith([descend(path(['name'])), descend(path(['whenCreated']))], updateCreatedAtFromFirebaseDate(data));
