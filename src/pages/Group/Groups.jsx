...
function Groups({
  ...
  const handleChangeCheck = function (e) {
    ...
    if (isChecked) {
      parentCallback([...checkedItems, ...groups.filter((i) => i.id === item)]);
      setCheckedItems([
        ...checkedItems,
        ...groups.filter((i) => i.id === item),
      ]);
    } else {
                ...
                >
                  <div className="self-center mr-3">
                    <Checkbox
                      ...
                      id={group.id}
                      checked={
                        checkedItems.filter((i) => i.id === group.id).length > 0
                      }
                  ...
                  <div className="grow flex items-center text-sm py-2">
                    <div
                      className="grow flex"
                      onClick={
                        noDetailView ? null : onClickView.bind(this, group)
                      }
                    >
                    ...
                    {noDetailView ? (
                      ...
                      <div
                        ...
                        onClick={onClickEdit.bind(this, group)}
                      >
